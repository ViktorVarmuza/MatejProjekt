...
<div class="w-full max-w-7xl mx-auto px-6 py-10">
    ...
    <div class="flex flex-col md:flex-row items-center justify-between gap-4 mb-10 bg-gray-100 px-6 py-4 rounded-xl shadow-sm border border-gray-200">
        ...
        <div class="w-full md:w-auto flex justify-end">
            <button
                ...
                class="w-full md:w-auto bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600 transition flex items-center justify-center gap-2">
    ...
    <div class="grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition duration-300 w-full flex flex-col">

            <div class="bg-gray-50 flex justify-center items-center h-40 flex-shrink-0">
